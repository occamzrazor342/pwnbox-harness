...
Every target in the list must fall within this project's `SCOPE_DOC` (see
`HARNESS.md`). Check the whole list before starting anything —
...
`orchestrations` array of `<ORCHESTRATION_ROOT>/registry.json`:
